...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(email_exists($email)){
        $error['Email'] = 'Email already exists, delete already existing appointment';
    }
    if($pnumber == ''){
        $error['PNumber'] = 'Phone number cannot be empty';
    }
    if(strlen($pnumber) < 9){
        $error['PNumber'] = 'Phone number have to be 9 characters length';
    }
    ...
    if(empty($error)){
       vaccination_register($name,$email,$pnumber,$ninumber,$date,$time);
       $_SESSION['message'] =  "You successfully registered for vaccination";
    }
}
...
<div class="container">
    <div class="row">
        <h1 class="text-center">Register for Vaccination</h1>
         <form method="post" action="register.php" enctype="multipart/form-data">
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="PNumber" class="form-control" placeholder="86xxxxxxx">
                    <p><?php echo isset($error['PNumber']) ? $error['PNumber'] : '' ?></p>
                </div>
                <div class="form-group">
                    <label for="name">National identification number</label>
                    <input type="text" name="NINumber" class="form-control" placeholder="xxxxxxxxxxx">
